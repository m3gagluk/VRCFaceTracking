...
namespace VRCFaceTracking.Varjo
{
    public class VarjoTracker
    {
        ...
        public struct GazeRay
        {
            ...
            //public Vector3 forward;   // Can't use Vector3 since it uses floats and not doubles
        ...
        public static void SessionSetPriority(int priority)
        {
            varjo_SessionSetPriority(session, priority);
        }
        ...
        [DllImport("VarjoLib", CharSet = CharSet.Auto)]
        public static extern void varjo_SessionSetPriority(IntPtr session, int priority);
